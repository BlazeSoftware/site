  ...
  render() {
    return (
      <main>
        ...
        <p class="o-container o-container--small u-large u-centered u-letter-box-large">
          Blaze UI provides great structure for building websites quickly with a scalable and maintainable foundation.
        </p>

        <div class="u-super u-letter-box-large u-centered">
          <stencil-route-link url="/getting-started/install" anchorClass="c-button c-button--brand c-button--round u-pillar-box-xlarge">
            Get started
          </stencil-route-link>
        </div>
        ...
        <div class="o-container o-container--super u-centered">
          <div class="o-grid o-grid--wrap o-grid--xsmall-full o-grid--small-full o-grid--medium-full">
            <div class="o-grid__cell o-grid__cell--width-33 u-window-box-super">
              ...
              <p class="c-paragraph">
                <span class="u-text--loud">Accessibile selectors</span> help to educate the importance of enabling everyone to access your site.
              </p>
            </div>
            <div class="o-grid__cell o-grid__cell--width-33 u-window-box-super">
              ...
              <p class="c-paragraph">
                <span class="u-text--loud">Any framework</span>, or no framework at all. You're not locked in. It's your choice.
              </p>
            </div>
            <div class="o-grid__cell o-grid__cell--width-33 u-window-box-super">
            ...
            <div class="o-grid__cell o-grid__cell--width-33 u-letter-box-super">
              ...
              <p class="o-paragraph">Our components rely solely on native browser features, not a separate library or framework.</p>
            </div>
            ...
            <div class="o-grid__cell o-grid__cell--width-33 u-letter-box-super">
              ...
              <p class="c-paragraph">See something wrong or want some new feature? Raise an issue or pull request. All feedback is welcome.</p>
            </div>
          </div>
        </div>
      </main>
